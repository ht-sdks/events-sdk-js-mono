 ...
 * @example ["@segment/analytics-core@1.0.0", "@ht-sdks/events-sdk-js@2.1.1"]
 */
...
/**
 *
 * @param rawTags - string delimited list of tags (e.g. `@ht-sdks/events-sdk-js@2.1.1 @segment/analytics-core@1.0.0`)
 */
